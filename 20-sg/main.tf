module "mysql_sg" {
    source = "git::https://github.com/Narayana-oruganti/terraform-aws-security-group.git?ref=main"
...
module "backend_sg" {
    source = "https://github.com/Narayana-oruganti/terraform-aws-security-group.git?ref=main"
    project_name = var.project_name
    environment = var.environment
    sg_name = "backend"
    vpc_id = local.vpc_id
...
module "vpn_sg" {
    source = "git::https://github.com/Narayana-oruganti/terraform-aws-security-group.gitt?ref=main"
    project_name = var.project_name
    environment = var.environment
